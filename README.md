A program to test the implementation of triangles using pytest. 
...
In the second screenshot, I artifically induced an error in the invalid triangle test by having all the sides of the triangle to be the same which would in turn, result in an equilateral triangle. Therefore, the expected output 
